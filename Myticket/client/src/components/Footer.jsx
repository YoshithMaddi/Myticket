    ...
    <footer className="px-6 md:px-16 lg:px-36 mt-40 w-full text-gray-300">
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
        <div className="md:max-w-96">
          <img className="w-36 h-auto" src={assets.logof} alt="logo" />
          <p className="mt-6 text-sm">
            Book your favorite shows effortlessly with Mytickets. Enjoy
            seamless, secure, and fast ticket booking anytime. Your
        ...
        <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              <p>+88888888</p>
              <p>myticketss13@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <p className="pt-4 text-center text-sm pb-5">
        Copyright {new Date().getFullYear()} © Mytickts
      </p>
    </footer>
  );
};
